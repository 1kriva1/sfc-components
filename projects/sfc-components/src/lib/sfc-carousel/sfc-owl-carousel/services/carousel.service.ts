...
import { OwlCarouselOConfig, OwlOptionsMockedTypes } from '../../../common/interfaces/sfc-carousel/sfc-owl-carousel/owl-carousel-o-config';
...
export class CarouselService {
   ...
   * All real items.
   */
  private _items: SfcCarouselSlideDirective[] = []; // is equal to this.slides
  ...
  private _pipe: any[] = [
    ...
    // },
    {
      ...
      run: () => {
        const clones: any[] = [],
          items: SfcCarouselSlideDirective[] = this._items,
   ...
   * @param options options set by user
   */
  setup(carouselWidth: number, slides: SfcCarouselSlideDirective[], options: OwlOptions) {
   ...
   * @param slides array of SfcCarouselSlideDirective
   */
  initialize(slides: SfcCarouselSlideDirective[]) {
   ...
   */
  items(position?: number): SfcCarouselSlideDirective[] {
    if (position === undefined) {
   ...
   */
  setItems(content: SfcCarouselSlideDirective[]) {
    this._items = content;
  }
