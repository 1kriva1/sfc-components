...
import { SfcLineTabComponent } from './sfc-line-tab.component';
import { By } from '@angular/platform-browser';

describe('Component: SfcLineTabComponent', () => {

    let component: SfcLineTabComponent;
    let fixture: ComponentFixture<SfcLineTabComponent>;
    let el: DebugElement;
    ...
    beforeEach(async(() => {
        TestBed.configureTestingModule({
            ...
            fixture = TestBed.createComponent(SfcLineTabComponent);
    ...
    it("SfcLineTabComponent: Should create component", async(() => {
